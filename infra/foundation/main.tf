...
locals {
  ...
  # /24 subnets carved out of the /16. Public: .0/.1/.., Private: .10/.11/..
...
resource "aws_subnet" "public" {
  ...
  tags = {
    ...
    Tier                     = "public"
    "kubernetes.io/role/elb" = "1" # so EKS (Phase 6) can place public load balancers here
  }
}
...
# ---- Private subnets: no internet route by default (cost-safe). Optional NAT. ----
